...
const policy = {
  ...
  policy_id: 'p@1',
  rules: { require_verified_controls: ['CAF-SDLC-002:tier'] },
};
const evidence = {
...
test('accepts evidence that meets an approved technical policy', () =>
  assert.equal(evaluateGuardrails(evidence, policy).accepted, true));
